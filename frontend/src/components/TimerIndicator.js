...
const TimerIndicator = ({ timerStarted, timerEnded }) => {
  ...
  return (
    <div className="hidden bg-white/90 backdrop-blur-sm rounded-2xl p-5 md:p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/20">
